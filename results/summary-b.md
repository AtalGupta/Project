...
| GPU/qwen2.5-1.5b-fp16 | 14.99 | 0.12 | 90% | 275 ms |
...
| CPU/qwen2.5-1.5b-fp16 | 12.71 | 1.09 | 76% | 2124 ms |
...
- **6 configuration(s) failed** and are recorded with their errors rather than omitted. Notably, the NPU does not support FP32 at any setting and reports this explicitly.

<sub>Sources: sweep-local.csv, sweep-precision.csv, sweep-precision2.csv</sub>
